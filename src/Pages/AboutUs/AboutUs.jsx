							...
							<div className="mt-0 mr-auto mb-10 ml-auto max-w-xl md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
							  ...
							  tracking-tight sm:text-4xl md:mx-auto"
								...
								<p className="text-base text-gray-700 md:text-lg">
									Embark on a voyage through the story of [Your Company Name],
									where passion for travel meets a commitment to creating
									unforgettable experiences. Learn about the team behind the
									scenes, dedicated to curating exceptional journeys that go
									beyond exploration. Join us in shaping moments that turn into
									lifelong memories, as we invite you to be part of our journey
