			...
			<Container>
				<div className="flex w-full mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 my-16">
					...
					<div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
						...
						<div className="mt-6">
							<button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-500 rounded-lg hover:bg-green-600 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
								Sign In
							</button>
						</div>
						...
						<div className="flex items-center justify-between mt-4">
							...
							<Link
								to={'/register'}
								className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline hover:decoration-green-500"
							>
								or sign up
							</Link>
