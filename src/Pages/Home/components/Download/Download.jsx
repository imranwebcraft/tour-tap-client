				...
				<section className="bg-white dark:bg-gray-900">
					<div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
						<h2 className="text-2xl font-bold tracking-tight text-gray-800 xl:text-3xl dark:text-white">
							Unlock the Full Experience: Download Our App Today!
						</h2>

						<p className="block max-w-4xl mt-4 text-gray-500 dark:text-gray-300">
							Enhance your travel journey with push notifications, personalized
							recommendations, and offline access – all in our app.Take our
							website with you wherever you go; download the app for an
							immersive travel experience.
						</p>

						<div className="mt-6">
							<a className="inline-flex items-center justify-center w-full px-4 py-2.5 overflow-hidden text-sm text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80 cursor-pointer">
								<svg
							...
							<a className="inline-flex items-center justify-center w-full px-4 py-2.5 mt-4 overflow-hidden text-sm text-white transition-colors duration-300 bg-blue-600 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80 cursor-pointer">
								<svg
									className="w-5 h-5 mx-2 fill-current"
