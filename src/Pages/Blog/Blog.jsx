						...
						>
							...
							<div className="p-6 space-y-2 lg:col-span-5">
								...
								<p>
									...
									promise unique experiences and unforgettable moments. Traverse
									off-the-beaten paths, where every corner holds a story waiting
									to be told. Join us as we unveil the secrets of enchanting
									places that capture the essence of travel beyond the ordinary.
								</p>
							</div>
						</a>
						<div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
							...
							>
								...
								<div className="p-6 space-y-2">
									...
									<p>
										...
										wonders. Join us on a flavorful expedition around the globe.
									</p>
								</div>
							</a>
							<a
							...
							>
								...
								<div className="p-6 space-y-2">
									...
									<p>
										...
										travel. From skydiving to mountain trekking, the excitement
										never ends.
									</p>
								</div>
							</a>
							...
							>
								...
								<div className="p-6 space-y-2">
									...
									<p>
										Immerse yourself in the rich tapestry of cultures worldwide.
										Our cultural immersion chronicles take you beyond landmarks,
										introducing you to traditions, festivals, and the soul of
										each destination.
									</p>
								</div>
							</a>
							...
							>
								...
								<div className="p-6 space-y-2">
									...
									<p>
										...
										natural marvels. Get ready to be captivated by the beauty of
										our planet.
									</p>
								</div>
							</a>
							...
							>
								...
								<div className="p-6 space-y-2">
									...
									<p>
										...
										compromising on experiences. Our tips and tricks will guide
										you to explore amazing destinations without breaking the
										bank. Start your affordable adventure today.
									</p>
								</div>
							</a>
							<a
